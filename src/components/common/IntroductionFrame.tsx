    ...
    >
      ...
      >
        <Image
          ...
          height={200}
        />
        <div className="absolute left-1/2 top-1/3 z-[1000] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center gap-y-0.5 text-xs font-medium text-title md:text-sm lg:text-base whitespace-nowrap">
          {children}
        </div>
      </div>
      <Image
